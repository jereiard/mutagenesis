...
#COPY mutagenesis .
RUN apt update && apt upgrade -y && apt install build-essential software-properties-common bcftools bbmap vim git gawk default-jre python3 python3-pip autoconf wget unzip libglib2.0-dev libncurses-dev libcurl4-openssl-dev curl zlib1g-dev libbz2-dev liblzma-dev -y
